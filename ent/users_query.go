...
func (uq *UsersQuery) Order(o ...Order) *UsersQuery {
	uq.order = append(uq.order, o...)
	return uq
}

// First returns the first Users entity in the query. Returns *ErrNotFound when no users was found.
func (uq *UsersQuery) First(ctx context.Context) (*Users, error) {
	...
	if len(us) == 0 {
		return nil, &ErrNotFound{users.Label}
	}
	return us[0], nil
}
...
// FirstID returns the first Users id in the query. Returns *ErrNotFound when no id was found.
...
func (uq *UsersQuery) FirstXID(ctx context.Context) int {
...
// Only returns the only Users entity in the query, returns an error if not exactly one entity was returned.
func (uq *UsersQuery) Only(ctx context.Context) (*Users, error) {
	...
	case 0:
		return nil, &ErrNotFound{users.Label}
	default:
		return nil, &ErrNotSingular{users.Label}
	}
}
...
// OnlyID returns the only Users id in the query, returns an error if not exactly one id was returned.
func (uq *UsersQuery) OnlyID(ctx context.Context) (id int, err error) {
	...
	case 0:
		err = &ErrNotFound{users.Label}
	default:
		err = &ErrNotSingular{users.Label}
	}
	return
}

// OnlyXID is like OnlyID, but panics if an error occurs.
func (uq *UsersQuery) OnlyXID(ctx context.Context) int {
...
func (uq *UsersQuery) Select(field string, fields ...string) *UsersSelect {
	selector := &UsersSelect{config: uq.config}
...
func (uq *UsersQuery) sqlQuery() *sql.Selector {
...
// UsersGroupBy is the builder for group-by Users entities.
...
func (ugb *UsersGroupBy) Aggregate(fns ...Aggregate) *UsersGroupBy {
...
// UsersSelect is the builder for select fields of Users entities.
